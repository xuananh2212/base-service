...
KEYSTORE_P12_FILENAME="kafka.keystore.p12"
KEYSTORE_KEY_FILENAME="kafka.key"
KEYSTORE_CERT_FILENAME="kafka.cert"
KEYSTORE_PEM_FILENAME="kafka.pem"
...
echo "Generate 12."
keytool -importkeystore -srckeystore $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_FILENAME  -destkeystore $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_P12_FILENAME -deststoretype PKCS12

echo "Generate PEM file."
openssl pkcs12 -in  $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_P12_FILENAME -out  $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_PEM_FILENAME

echo "Generate CERT file."
openssl pkcs12 -in $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_P12_FILENAME -nokeys -out $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_CERT_FILENAME
echo "Generate KEY file."
openssl pkcs12 -in $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_P12_FILENAME -nocerts -nodes -out $KEYSTORE_WORKING_DIRECTORY/$KEYSTORE_KEY_FILENAME
echo
echo "All done!"
echo
